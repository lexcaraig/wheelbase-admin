...
const devContent = environmentContent.replace('production: true', 'production: false');
fs.writeFileSync(
  path.join(environmentsDir, 'environment.development.ts'),
  devContent
);
console.log('✅ Generated src/environments/environment.development.ts');

// Write production environment
const prodContent = environmentContent.replace('production: false', 'production: true');
fs.writeFileSync(
